...
def main() -> None:
    ...
    required_filename_tool_markers = [
        ...
        "`PL_LP_${sampleLabel}${polToken}_${linearB}T_${t}K`",
        "`Raman_LP_${sampleLabel}_${grating}${polToken}_${linearB}T_${t}K`",
        "const linearB = b || '0'",
        "showField('#lbl_fnB', type === 'MagnetDep' || type === 'CircularPol' || type === 'LinearPolPL' || type === 'LinearPolRaman')",
        "圆偏振 PL / 四通道分析",
        "圆偏振 PL（四通道）",
